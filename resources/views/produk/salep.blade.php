                ...
                <div class="row justify-content-center align-items-center g-4 g-lg-0 bg-lg-white">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap align-items-start flex-row-reverse">
                                <div class="singlethumb__left nav flex-sm-column nav-pills ms-md-3" id="v-pills-tab"
                                    ...
                                    <div class="nav-link active" id="thumbOne-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true">
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/cream1.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                    <div class="nav-link" id="thumbTwo-tab" data-bs-toggle="pill" data-bs-target="#thumbTwo"
                                        ...
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/cream2.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                    <div class="nav-link" id="thumbThree-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="false">
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/cream3.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                    <div class="nav-link" id="thumbFour-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="false">
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/cream4.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="singlecontent">
                            ...
                            <p>Nashir Cream adalah krim topikal yang diformulasi khusus untuk mengatasi keluhan ambeien/wasir. Mengandung bahan berkualitas yang diolah secara modern menggunakan teknologi tinggi dan sudah teruji klinis.
                            </p>
                            <br>Manfaat
                            <ul>
                                <li>Mengurangi nyeri</li>
                                <li>Membantu mengempeskan benjolan ambeien/wasir.</li>
                                <li>Mengempeskan pembengkakan</li>
                                <li>Sebagai antiinflamasi dan antibakteri </li>
                                <li>Membantu meredakan tekanan di sekitar anus</li>
                                <li>Membantu mengurangi peradangan</li>
                                <li>Membantu mempercepat penyembuhan luka dan mengurangi rasa sakit</li>
