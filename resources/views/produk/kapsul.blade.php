                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap align-items-start flex-row-reverse">
                                <div class="singlethumb__left nav flex-sm-column nav-pills ms-md-3" id="v-pills-tab"
                                    ...
                                    <div class="nav-link active" id="thumbOne-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true">
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/kapsul1.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                    <div class="nav-link" id="thumbTwo-tab" data-bs-toggle="pill" data-bs-target="#thumbTwo"
                                        ...
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/kapsul2.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                    <div class="nav-link" id="thumbThree-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="false">
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/kapsul3.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                    <div class="nav-link" id="thumbFour-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="false">
                                        <div class="thumb">
                                            <img src="{{ asset('images/produk/kapsul4.png') }}" alt="rajibraj">
                                        </div>
                                    </div>
                                </div>
